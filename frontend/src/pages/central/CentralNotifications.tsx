...
import { Download, Bell, Mail, CheckCircle2, AlertCircle } from 'lucide-react';
      ...
      >
        ...
        >
          ...
          <p className="text-emerald-800/60 font-medium mt-3 max-w-2xl mx-auto sm:mx-0">
            Review important alerts, reminders, and status updates regarding national environmental clearance applications.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="px-6 py-5 sm:px-8 sm:py-6 border-b border-emerald-100/60 flex items-center justify-between bg-emerald-50/30">
            ...
            <span className="text-xs font-bold bg-emerald-100 text-emerald-700 px-3 py-1 rounded-full shadow-sm">
