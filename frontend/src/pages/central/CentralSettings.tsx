                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                      <div className="space-y-2">
                        ...
                        <input 
                          {...register('name')} 
                          readOnly
                          className="w-full px-5 py-4 bg-emerald-50/50 border border-emerald-100/50 rounded-2xl text-emerald-950/70 font-bold shadow-sm cursor-not-allowed select-none" 
                          title="Your name cannot be changed after registration"
