...
export const mockManuals: Manual[] = [
  { id: '1', title: 'User Manual for Project Proponents', description: 'Complete guide for submitting proposals via PARIVESH', category: 'General', fileSize: '4.2 MB', downloadUrl: '#' },
