...
import { LayoutDashboard, Bell, Settings, LogOut, Menu, Users, FolderKanban, FileText } from 'lucide-react';
...
const sidebarLinks = [
  ...
  { icon: FileText, label: 'MoM Team', path: '/committee/mom-team' },
...
export default function CommitteeReviewerLayout() {
